...
class SphericalPortalSystem:
    ...
    def __init__(self, level_model, lights, portal_pos):
        ...
        portal_generator = shared_models["portal_generator.bam"]
        ...
        self.tunnel_model_0 = shared_models["wrecked_tunnel.bam"]
        ...
        tunnel_collision = section2_models["wrecked_tunnel_collision.bam"]
